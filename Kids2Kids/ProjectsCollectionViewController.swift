...
class ProjectsCollectionViewController: UICollectionViewController {
    ...
    func setupController() {
        navigationItem.title = NSLocalizedString("Проекты", comment: "projects")
    }

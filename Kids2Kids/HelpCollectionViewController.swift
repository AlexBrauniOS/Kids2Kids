...
class HelpCollectionViewController: UICollectionViewController {
    ...
    var helpArray: [Help] = [Help(name: NSLocalizedString("Финансовая помощь", comment: "financial help"), image: #imageLiteral(resourceName: "talkHeart"), description: NSLocalizedString("Благотворительный фонд «Дети Детям» будет благодарен любой помощи. \nФинансовую помощь фонду Вы можете оказать по следующим реквизитам: \nПриватБанк \nр/с 26000056127077 \nМФО 380775 \nЕДРПО 41350891 \n\nНазначение платежа: \n«Благотворительный взнос»", comment: "financial help desc"), color: .fundGreenColor),
                             Help(name: NSLocalizedString("Конкретному ребёнку", comment: "for child"), image: #imageLiteral(resourceName: "heart"), description: NSLocalizedString("Помогать конкретному ребёнку можно, подключив ежемесячное пожертвование в рамках проекта «Щастя в кожну родину». \n\nКоманда благотворительного фонда «Дети Детям» регулярно получает просьбы о помощи от семей с тяжелобольными детьми. \n\nКак работает проект: \n1.Мы встречаемся с родителями детей и принимаем решение о включении семьи в программу фонда; \n2.Составляем список и бюджет ежемесячных нужд отдельно для каждой семьи c тяжелобольным ребенком; \n3.Регулярно финансируем семьи благодаря пожертвованиям друзей фонда и наших партнеров. \n\nПрисоединяйтесь к проекту! \nВаши ежемесячные пожертвования могут помочь тяжелобольным детям!", comment: "for child desc"), color: .fundRedColor),
                             Help(name: NSLocalizedString("Передать вещи", comment: "clothes"), image: #imageLiteral(resourceName: "star"), description: NSLocalizedString("У Вас остались почти новые обувь и вещи? Чистые и исправные вещи еще могут послужить! \n\nДети из детских домов и школ-интернатов примут их с радостью. Видя чистые, выглаженные и аккуратно сложенные в пакет вещи, дети почувствуют вашу заботу и будут благодарны за подарок! \n\n Самые актуальные нужды: \n - одежда всех сезонов и разных размеров; \n - обувь всех сезонов, назначений и размеров (тапочки, спортивные кеды и кроссовки, др.); \n - спортивная одежда; \n - шапки, варежки, шарфы; \n - постельное белье, одеяла, пледы, подушки; \n - средства личной гигиены; \n - памперсы, одноразовые пеленки. \n\nЕсли у вас есть эти сокровища, то несите их к нам!", comment: "clothes desc"), color: .fundBlueColor),
                             Help(name: NSLocalizedString("Стать волонтёром", comment: "volunteer"), image: #imageLiteral(resourceName: "angel"), description: NSLocalizedString("Волонтеры - это люди, без которых сложно представить полноценную работу фонда! \n\nПомогать в проведении мероприятий, участвовать в программе профориентации будущих выпускников. \n\nЧем Вы можете помочь фонду «Дети Детям»: \n - закупать и развозить нужды в детдома, школы-интернаты, семьи; \n - помогать проводить мероприятия; \n - оказывать психологическую помощь детям и родителям тяжело-больных детей; \n - проводить обучение в рамках программы профориентации (проект «Дорога в жизнь»).", comment: "volunteer desc"), color: .fundYellowColor),
                             Help(name: NSLocalizedString("Организациям", comment: "companies"), image: #imageLiteral(resourceName: "cloud"), description: NSLocalizedString("Приглашаем компании поддержать наши проекты помощи детдомам, школам-интернатам, реабилитационным центрам: \n - отправка детей в детские лагеря; \n - покупка мебели; \n - оплата ремонтных работ; \n - покупка бытовой техники", comment: "companies desc"), color: .fundGreenColor)]
    ...
    func setupController() {
        navigationItem.title = NSLocalizedString("Помощь", comment: "help")
    }
